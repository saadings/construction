...
export default defineConfig(({ mode }) => {
  ...
  const resolve = {
    alias: {
      ...
      // What shadcn's own components import themselves by. Declared in both tsconfigs already, so this is the same mapping said where the test runner can read it rather than a second convention.
