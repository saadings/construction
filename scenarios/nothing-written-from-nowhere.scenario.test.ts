...
const NOBODY_CAN_REACH_YET: Record<string, string> = {
  ...
  'contracts.agree': 'what a client agreed to pay can be read on the house and put in nowhere',
  'contracts.measure': 'and the house cannot be measured again',
  'contracts.revise': 'and a rate typed wrong cannot be corrected',
  'contracts.cancel': 'and a contract cannot be called off',
  'extraWork.raise': 'extra work can be read and never raised',
  'extraWork.takeBack': 'and never taken back',
  'milestones.add': 'the stages a contract is billed in can be read and never set',
  'milestones.bill': 'and a stage cannot be billed, which is the money the client is actually asked for',
  ...
  'profitShares.agree': 'a share is customisable everywhere except on a screen, which is the next thing being built',
  'profitShares.followTheMoney': 'and a house cannot be put back to shares that follow what each of them put in',
